...
def afg_randome():
	...
	with tred(max_workers=30) as ahd:
		...
		for guru in user:
			ids = kode+guru
			mking_pass = [ids,guru,'first123','first1234','first12345','first123456','first11','first1122','first112233','first11223344','firstlast123','firstlast1234','firstlast12345']
